...
Savasthi Investment Ltd                          name                                  Savasthi Investment Ltd                   1
Lic Of India Money Plus -1                      ,prxmatch(                             Lic Of India Money Plus -1                0
Life Insurance Corporation Of India Ltd          '/\s(Investment|Ltd|Pvt|Fund)/i'      Life Insurance Corporation Of India Ltd   1
Norges Bank A/C Government Petroleum Fund        ,strip(name))>0 as match              Norges Bank A/C Government Petroleum Fund 1
Reliance Capital Trustee Co Ltd A/C            from                                    Reliance Capital Trustee Co Ltd A/C       1
Sundaram Bnp Paribas Mutual Fund A/C             sd1.have                              Sundaram Bnp Paribas Mutual Fund A/C      1
Swiss Finance Corporation Mauritius Ltd      ;quit;                                    Swiss Finance Corporation Mauritius Ltd   1
...
St. Helens Nominees India Pvt                  select                                  SAS
;;;;                                             name                                  NAME                                  MATCH
run;quit;                                       ,regexp_like(
                                                   name                                investor_name                             0
                                                 ,'\\s(Investment|Ltd|Pvt|Fund)')      Gujarat Venture Capital Fund-1995         1
                                                   as match                            Narendra Manibhai Patel                   0
                                               from                                    Emirates Bank International Pjsc          0
                                                 have                                  Lic Of India Money Plus                   0
                                               ")                                      Savasthi Investment Ltd                   1
                                             want                                      Lic Of India Money Plus -1                0
                                             fn_tosas9x(                               Life Insurance Corporation Of India Ltd   1
                                                   inp    = want                       Norges Bank A/C Government Petroleum Fund 1
                                                  ,outlib ="d:/sd1/"                   Reliance Capital Trustee Co Ltd A/C       1
                                                  ,outdsn ="want"                      Sundaram Bnp Paribas Mutual Fund A/C      1
                                             ...
                                             ;;;;                                      Acacia Institutional Partners Lp          0
                                             %utl_rendx;                               Acacia Partners Lp                        0
                                                                                       St. Helens Nominees India Pvt             1
...
proc sql;
  ...
  from
    have
  where
    name contains ("Ltd","Pvt")
;quit;


   ,prxmatch(
     '/\b(Investment|Ltd|Pvt|Fund)\b/i'
     ,strip(name))>0 as match
  from
    sd1.have
;quit;
...
Deep Star Investment & Finance Co Pvt Ltd
Santosh S Goenka
...
Jainam Sec Pvt Ltd
Suman L Shah
Winever Investment & Consultants Pvt Ltd
Acacia Institutional Partners Lp
Acacia Partners Lp
Aic Advantage Fund
Bharat K. Sheth
...
Passport Capital Llc A/C Passport India
Pivotal Securities Pvt Ltd
Ravi K. Sheth
Reliance Capital Trustee Company Ltd A/C
Reliance Capital Trustee Company Ltd A/C
Reliance Capital Trustee Company Ltd A/C
Reliance Life Insurance Company Ltd
Aberdeen Asset Managers Ltd A/C Aberdeen
General Insurance Corporation Of India
Icici Prudential Life Insurance Company Ltd
Lic Of India Market Plus
Lic Of India Money Plus
Life Insurance Corporation Of India
Life Insurance Corporation Of India Profit
Canbank Financial Services Ltd
Naresh K Aggarwala
St. Helens Nominees India Pvt Ltd
;;;;
run;quit;
...
want<-sqldf("
  ...
  from
    have
  where
    regexp_like(name, '\b(Investment|Ltd|Pvt|Fund\b')
  ")
want
fn_tosas9x(
      inp    = want
...
want<-sqldf("
  select
    name
   ,regexp_like(name, '\b(Investment|Ltd|Pvt|Fund\b') as match
  from
    have
  where
    regexp_like(name, '\b(Investment|Ltd|Pvt|Fund)\b')
...
want<-sqldf("
  ...
  from
    have
  where
    regexp_like(name, '\\s(Investment|Ltd|Pvt|Fund)\\s')
  ")
want
fn_tosas9x(
      inp    = want
...
data demo;
  set sd1.have;
  match_flag=prxmatch('/\b(Investment|Ltd|Pvt|Fund)\b/i',strip(name))>0;
run;quit;
datalines;
Gujarat Venture Capital Fund-1995
Narendra Manibhai Patel
